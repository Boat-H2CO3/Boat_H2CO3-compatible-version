package org.koishi.launcher.h2co3.launcher.control;
/*
...
import org.koishi.launcher.h2co3.launcher.control.gamecontroller.codes.Translation;
import org.koishi.launcher.h2co3.launcher.control.gamecontroller.definitions.id.key.KeyEvent;
...
public class H2CO3CustomManager implements OnTouchListener, CompoundButton.OnCheckedChangeListener, OnClickListener {
    ...
    private void Deserialization() {
        ...
        try {
            FileReader reader = new FileReader(CustomButtonStoragePath);
