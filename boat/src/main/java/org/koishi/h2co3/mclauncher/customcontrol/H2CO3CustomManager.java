...
public class H2CO3CustomManager implements OnTouchListener, CompoundButton.OnCheckedChangeListener, OnClickListener {
	...
	private Handler ContainerCallBackPressTimer = new Handler();
	private Runnable ContainerCallBackLongTouchTask = new Runnable() {
		@Override
		public void run() {
	...
	private Handler PressTimer = new Handler();
	private H2CO3CustomButton CurrentKeyPress;
	private Runnable PressTimeTask = new Runnable() {
		@Override
		public void run() {
	...
	public void CustomButtonDialog(boolean CreateOrEdit) {
		...
		if (alert_h2co3custom_main_edit_name == null) {
			...
			CustomButtonDialog = new AlertDialog.Builder(context)
	...
	private void ColorSelect(View vi, EditText edit) {
		...
		if (ColorSelectDialog == null) {
			...
			ColorSelectDialog = new AlertDialog.Builder(context)
