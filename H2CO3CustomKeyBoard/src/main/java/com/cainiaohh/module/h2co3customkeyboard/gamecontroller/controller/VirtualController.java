...
import static com.cainiaohh.module.h2co3customkeyboard.gamecontroller.definitions.id.key.KeyEvent.MARK_KEYNAME_SPLIT;
import static com.cainiaohh.module.h2co3customkeyboard.gamecontroller.definitions.id.key.KeyEvent.MOUSE_BUTTON;
import static com.cainiaohh.module.h2co3customkeyboard.gamecontroller.definitions.id.key.KeyEvent.MOUSE_POINTER;
import static com.cainiaohh.module.h2co3customkeyboard.gamecontroller.definitions.id.key.KeyEvent.MOUSE_POINTER_INC;
import static com.cainiaohh.module.h2co3customkeyboard.gamecontroller.definitions.id.key.KeyEvent.TYPE_WORDS;
...
import com.cainiaohh.module.h2co3customkeyboard.gamecontroller.input.log.DebugInfo;
import com.cainiaohh.module.h2co3customkeyboard.gamecontroller.input.screen.CrossKeyboard;
import com.cainiaohh.module.h2co3customkeyboard.gamecontroller.input.screen.CustomizeKeyboard;
import com.cainiaohh.module.h2co3customkeyboard.gamecontroller.input.screen.InputBox;
import com.cainiaohh.module.h2co3customkeyboard.gamecontroller.input.screen.ItemBar;
import com.cainiaohh.module.h2co3customkeyboard.gamecontroller.input.screen.OnscreenJoystick;
import com.cainiaohh.module.h2co3customkeyboard.gamecontroller.input.screen.OnscreenKeyboard;
import com.cainiaohh.module.h2co3customkeyboard.gamecontroller.input.screen.OnscreenTouchpad;
...
public class VirtualController extends BaseController implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public void init() {
        ...
        for (View v : new View[]{buttonCustomizeKeyboard, buttonOK, buttonResetPos, buttonPCKeyboard, buttonPEKeyboard, buttonPEJoystick, buttonPEItembar, buttonTouchpad, buttonInputBox, buttonDebugInfo}) {
            v.setOnClickListener(this);
        }

        for (SwitchCompat s : new SwitchCompat[]{switchCustomizeKeyboard, switchPCKeyboard, switchPEKeyboard, switchPEJoystick, switchPEItembar, switchTouchpad, switchInputBox, switchDebugInfo}) {
